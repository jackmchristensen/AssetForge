...
classes = (asset_forge.AF_OT_export, asset_forge.AF_OT_reset_default, asset_forge.AF_PT_panel, asset_forge.AF_Settings, asset_forge.AF_PT_Settings, asset_forge.AF_PT_Naming, asset_forge.AF_PT_Budgets)
