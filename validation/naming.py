...
# Generated by ChatGPT
KNOWN_PREFIXES = ("sm", "m", "t", "tex", "texture", "mat", "mi", "material", "mesh", "staticmesh", "static_mesh", "geo")
...
def normalize_mesh_name(name: str) -> str:
    prefix: str = config.get_setting("naming_conventions.mesh_prefix", "SM_")
    base = _strip_known_prefix(name)

    return f"{prefix}{base}"


def normalize_material_instance_name(name: str) -> str:
    prefix: str = config.get_setting("naming_conventions.material_instance_prefix", "MI_")
    base = _strip_known_prefix(name)
